# Linux-Mint-21.3-Cinnamon-Conky-v1.19.8-w-mouse-click-events
how to hybrid this older platform for the newer conky build

This installs a newer conky with mouse click support from source to the Linux Mint 21.3 Cinnamon platform
